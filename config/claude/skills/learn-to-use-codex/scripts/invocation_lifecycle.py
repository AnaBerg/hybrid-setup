...
and report validity, terminates the original process group on timeout
or cancellation (detached descendants require caller verification), and manages learning-hook ownership markers so a
